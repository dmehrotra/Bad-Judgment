...
Sentence.prototype.cantSleep = function() {
    ...
    if (this.data.data.home) {
        var ar = [ "It's late, you should be asleep but you check me one more time just to be sure. The date is " + this.data.data.date.replace("EDTIP", "") + " and you are at home in " + this.data.data.city + ".", "You had that dream again and now you are awake. It's " + this.data.data.date.replace("EDTIP", "") + " and you are checking me to forget.", "You are at home and can't sleep again. The date is " + this.data.data.date.replace("EDTIP", "") + " and you are looking for picture of yourself when you were young, again." ];
...
Sentence.prototype.work = function() {
    var ar = [ "You are bored at work on " + this.data.data.date.replace("EDTIP", "") + ". You resize your a new browser window, so that it is small enough not to be seen by those around you. As you start typing 'faceb', you think to yourself, 'tomorrow I am going to look for a new job'.", "On " + this.data.data.date.replace("EDTIP", "") + " you look your boss up on facebook.  In her profile picture she is holding a cocktail, but you could have sworn she said she was sober.", "On your work computer " + this.data.data.date.replace("EDTIP", "") + ", you accidently return to facebook, after typing f into google chrome.", "You are at work and you want to quit. It's " + this.data.data.date.replace("EDTIP", "") + ", you march over to your boss and ask if she want's to chat over a drink after work.  She says she is sober.  You log into facebook and consider removing every photo of yourself." ];
    this.advertisement = "linkedin";
    return ar[Math.floor(Math.random() * ar.length)];
};

Sentence.prototype.workLate = function() {
    var ar = [ "You at work late on " + this.data.data.date.replace("EDTIP", "") + ". You are hungry and tired. Your boss just doesn't pay enough attention to all the work that you are putting in and you can't help but feel like your life isn't going anywhere. As you start typing 'faceb', you think to yourself, 'tomorrow I am going to look for a new job'.", "You are at work late again on " + this.data.data.date.replace("EDTIP", "") + ". You hear somone shuffling around in the hallway.  When you peer over your partition to see who it is, you find your boss sleeping on the floor.  You check me for updates and find out that the identical twin of someone you used to know from high school has passed away." ];
    this.advertisement = "linkedin";
    return ar[Math.floor(Math.random() * ar.length)];
};
