...
Sentence.prototype.cantSleep = function() {
    ...
    if (this.data.data.home) {
        var ar = [ "It's late, you should be asleep but you check me one more time just to be sure. The date is " + this.data.data.date.replace("EDTIP", "") + " and you are at home in " + this.data.data.city + ".", "You had that dream again and now you are awake. It's " + this.data.data.date.replace("EDTIP", "") + " and you are checking me to forget.", "You are at home and can't sleep. The date is " + this.data.data.date.replace("EDTIP", "") + " and you are looking for picture of yourself when you were young, again." ];
